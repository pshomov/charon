...
public class EnumClassParams {
    private MappingsTest.TestEnum newVale = MappingsTest.TestEnum.a;

    public EnumClassParams() {
    }
    public MappingsTest.TestEnum getA(){return newVale;}
    public void setA(MappingsTest.TestEnum newVale){
